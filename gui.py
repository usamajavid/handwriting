...
if uploaded_file is not None:
    ...
    if st.button('predict'):
        ...
        print(BASELINE_ANGLE)
        print("baseline angle is",comment1 +" :",BASELINE_ANGLE)
        # print(top_margin)
        
        print("Top Margin is",comment2+" :",TOP_MARGIN)
        # print(letter_size)
        print("Letter Size is",comment3+" :",LETTER_SIZE)


        # print(line_spacing)
        print("Line Spacing is",comment4+" :",LINE_SPACING)

        # print(word_spacing)
        print("Word Spacing is",comment5+" :",WORD_SPACING)



        # print(slant_angle)
        print("Slant Angle is",comment7+" :",SLANT_ANGLE)
        # print(pen_pressure)
        print("Pen Pressure",comment6+" :",PEN_PRESSURE)
